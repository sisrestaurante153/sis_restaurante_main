    ...
    <Stack spacing={3}>
      <Tabs defaultValue="suppliers" className="w-full">
        <TabsList className="mb-6 flex-wrap h-auto justify-start">
          ...
          <TabsTrigger value="operational-categories">Categorias operacionais</TabsTrigger>
          <TabsTrigger value="modalities">Modalidades</TabsTrigger>
          <TabsTrigger value="item-types">Tipos de item</TabsTrigger>
          <TabsTrigger value="stage-types">Tipos de etapa</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="operational-categories" className="mt-0 outline-none">
          <FormSection
        ...
        <TabsContent value="modalities" className="mt-0 outline-none">
          <FormSection
            title="Modalidades"
        ...
        <TabsContent value="item-types" className="mt-0 outline-none">
          <FormSection
            title="Tipos de item"
        ...
        <TabsContent value="stage-types" className="mt-0 outline-none">
          <FormSection
